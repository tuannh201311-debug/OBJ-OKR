...
import { LayoutDashboard, Network, Settings, Shield, LogOut, FileText, Sparkles, History } from 'lucide-react';
...
export function Layout() {
  ...
  const navigation = [
    ...
    { name: 'Nhật ký hoạt động', href: '/activity-logs', icon: History, adminOnly: true },
